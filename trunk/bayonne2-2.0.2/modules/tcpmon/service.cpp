...
Keydata("/bayonne/module/tcpmon")
{
	...
	load(defkeys);
#ifdef	WIN32
	loadFile("C:\\Program Files\\GNU Telephony\\Bayonne Config\\module.ini", "tcpmon");
#endif
...
{
	InetAddress addr(getLast("interface"));
	tpport_t port = atoi(getLast("port"));
